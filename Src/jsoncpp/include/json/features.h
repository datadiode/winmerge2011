...
union Features {
  ...
  bitmask<allowComments> allowComments_;
  bitmask<strictRoot> strictRoot_;
  bitmask<allowDroppedNullPlaceholders> allowDroppedNullPlaceholders_;
  bitmask<allowNumericKeys> allowNumericKeys_;
  Features(Flags flags): flags(flags) { }
};
