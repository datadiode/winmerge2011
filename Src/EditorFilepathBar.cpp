...
{
	int nTextColor = bActive ? COLOR_CAPTIONTEXT : COLOR_INACTIVECAPTIONTEXT;
	int nBackColor = bActive ? COLOR_ACTIVECAPTION : COLOR_INACTIVECAPTION;
	//set text color
	...
	return GetSysColorBrush(nBackColor);
}
